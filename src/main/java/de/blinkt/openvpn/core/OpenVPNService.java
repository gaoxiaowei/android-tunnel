...
public class OpenVPNService extends VpnService implements StateListener, Callback, ByteCountListener, IOpenVPNServiceInternal {
    ...
    private final IBinder mBinder = new IOpenVPNServiceInternal.Stub() {
        ...
        @Override
        public boolean protect(ParcelFileDescriptor fd) throws RemoteException {
    ...
    public void onRevoke() {
        ...
        endVpnService(true);
        PIAOpenVPNTunnelLibrary.mNotifications.showRevokeNotification(this);
    ...
    private void endVpnService(boolean closeTun) {
        ...
        if (closeTun)
            KillSwitch.closeOpenVPNFdIfOpen(this);
    }
    ...
    private void showNotification(final String msg, String tickerText, @NonNull String channel, long when, ConnectionStatus status) {
        ...
        PIAOpenVPNTunnelLibrary.mNotifications.addPiaNotificationExtra(nbuilder, this, mDeviceStateReceiver);
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (intent != null && intent.hasExtra(getPackageName() + ".profileUUID")) {
            ...
            if (mProfile == null) {
                ...
                mProfile = PIAOpenVPNTunnelLibrary.mCallbacks.getAlwaysOnProfile();
                Log.d("OpenVPN","mProfile = " + mProfile);
                if (mProfile == null) {
                    stopSelf(startId);
                    return START_NOT_STICKY;
                }
