...
*/
    ...
    /**
     * (schwabe) This seems to be a horrible replacement for addListener method that gets immeaditely
     * triggers a call to the listener add gives last status.
     */
    @Deprecated
    public static ConnectionStatus getmLastLevel() {
        return mLastLevel;
    }
     ...
     */
    @Deprecated
    public static String getmLaststate() {
        return mLaststate;
    }
     ...
     */
    @Deprecated
    public static int getmLastStateresid() {
        return mLastStateresid;
    }
